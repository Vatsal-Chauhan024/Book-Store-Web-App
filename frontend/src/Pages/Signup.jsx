		...
		<div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
			<div class="max-w-md mx-auto">
				...
				<div class="divide-y divide-gray-200">
					<form onSubmit={handleSingup} class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
						<div class="relative">
                        ...
                        <p>If you already have an account. Please <Link to = "/login" className='text-blue-600 underline cursor-pointer'>Login</Link></p>
						<div class="relative">
							<button class="bg-blue-700 hover:bg-black transition-all duration-300 text-white rounded-md px-2 py-1">Signup</button>
						</div>
					</form>
